...
function OgPreview() {
  return (
    <div className="fixed left-0 top-0 z-[60] flex h-[628px] w-[1200px] items-center overflow-hidden bg-paper">
      <div
      ...
      <div className="relative z-10 flex-1 space-y-8 pl-20 pr-6">
        <div className="flex items-center gap-4">
          <span className="grid size-12 place-items-center rounded-xl border-2 border-ink bg-stamp text-paper-bright shadow-[3px_3px_0_var(--ink)]">
        ...
        <div className="space-y-4">
          ...
          <span className="label-caps inline-flex items-center rounded-full border-2 border-ink bg-paper-bright px-5 py-2 text-sm text-muted-foreground shadow-[2px_2px_0_var(--ink)]">
      ...
      {/* Right: the ticket */}
      <div className="relative z-10 w-[480px] shrink-0 pr-16">
        <div className="plate rotate-2">
          ...
          <div className="tear-line p-6">
            <div className="flex items-center gap-3 rounded-lg border-2 border-ink bg-paper p-2 pl-4">
              ...
              <span className="inline-flex h-11 shrink-0 items-center gap-2 rounded-lg border-2 border-ink bg-seal px-4 text-sm font-bold uppercase tracking-wider text-paper-bright shadow-[3px_3px_0_var(--ink)]">
