...
function Home() {
    ...
    return (
        ...
        <span
            className="label-caps inline-flex items-center gap-2 rounded-full border-2 border-ink bg-paper-bright px-4 py-1.5 text-muted-foreground shadow-[2px_2px_0_var(--ink)]">
